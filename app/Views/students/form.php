...
// Helper para mas short ang form fields below.
    ...
    <form method="post" action="<?= View::e($action) ?>">
        ...
        <div>
            <div>
                ...
                <input id="student_number" name="student_number" value="<?= View::e($value('student_number')) ?>">
            </div>

            <div>
                <label for="course">Course</label>
                <input id="course" name="course" value="<?= View::e($value('course')) ?>" placeholder="BSIT">
            </div>

            <div>
                <label for="first_name">First Name</label>
                <input id="first_name" name="first_name" value="<?= View::e($value('first_name')) ?>">
            </div>

            <div>
                <label for="last_name">Last Name</label>
                <input id="last_name" name="last_name" value="<?= View::e($value('last_name')) ?>">
            </div>
            ...
            <div>
                ...
                <input id="email" name="email" value="<?= View::e($value('email')) ?>">
            </div>
